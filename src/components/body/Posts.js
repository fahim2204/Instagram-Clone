                    ...
                    return (
                        <div className="row bg-white rounded-2 border my-3 pb-2">
                            ...
                            <div className="col-12 pt-2">
                                <span className="ms-2 fw-bold"><small>{item.likes} Likes</small></span>
                            </div>
